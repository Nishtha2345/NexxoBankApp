...
--
-- Dumping data for table `password1`
--

LOCK TABLES `password1` WRITE;
/*!40000 ALTER TABLE `password1` DISABLE KEYS */;
/*!40000 ALTER TABLE `password1` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-10-14 17:08:38
