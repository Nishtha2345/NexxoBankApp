...
LOCK TABLES `transaction_action` WRITE;
/*!40000 ALTER TABLE `transaction_action` DISABLE KEYS */;
INSERT INTO `transaction_action` VALUES (1,'transfer'),(2,'withdraw');
/*!40000 ALTER TABLE `transaction_action` ENABLE KEYS */;
UNLOCK TABLES;
